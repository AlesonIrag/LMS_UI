...
export class Dashboard implements OnInit, OnDestroy {
  ...
  private initializeSidebarVisibility(): void {
    ...
    } else if (currentUrl.includes('/dashboard/login-logout-events')) {
      this.activeSection = 'login-logout-events';
    } else if (currentUrl.includes('/dashboard/student-login-logout')) {
      this.activeSection = 'student-login-logout';
